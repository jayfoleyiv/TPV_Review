...
\begin{keyword}
\texttt{elsarticle.cls}\sep Optical design and fabrication \sep Optical Devices \sep Optics at surfaces \sep Thin Films \sep Solar Energy \sep Subwavelength structures, nanostructures
\end{keyword}
